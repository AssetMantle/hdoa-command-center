...
func NewMsgCreateDomain(creator string, docPathway bool, nursePathway bool, adminPathway bool, pharmaPathway bool, pathModelling bool, resourceTracing bool) *MsgCreateDomain {
	return &MsgCreateDomain{
		Creator:         creator,
		DocPathway:      docPathway,
		NursePathway:    nursePathway,
		AdminPathway:    adminPathway,
		PharmaPathway:   pharmaPathway,
		PathModelling:   pathModelling,
		ResourceTracing: resourceTracing,
	}
}
...
func NewMsgUpdateDomain(creator string, id uint64, docPathway bool, nursePathway bool, adminPathway bool, pharmaPathway bool, pathModelling bool, resourceTracing bool) *MsgUpdateDomain {
