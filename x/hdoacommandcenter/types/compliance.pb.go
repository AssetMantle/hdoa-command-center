...
// source: hdoacommandcenter/hdoacommandcenter/compliance.proto
...
func (*Compliance) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce2fbd64a4c31ef7, []int{0}
}
...
func (m *Compliance) GetId() uint64 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *Compliance) GetHipaaOversight() bool {
	if m != nil {
...
func (m *Compliance) GetGovOversight() bool {
	if m != nil {
...
func (m *Compliance) GetDataSecCompliance() bool {
	if m != nil {
...
func (m *Compliance) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Compliance)(nil), "hdoacommandcenter.hdoacommandcenter.Compliance")
}

func init() {
	proto.RegisterFile("hdoacommandcenter/hdoacommandcenter/compliance.proto", fileDescriptor_ce2fbd64a4c31ef7)
}

var fileDescriptor_ce2fbd64a4c31ef7 = []byte{
	...
	,
}

func (m *Compliance) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *Compliance) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Compliance) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Creator) > 0 {
		...
		i = encodeVarintCompliance(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x2a
	}
	...
	if m.Id != 0 {
		i = encodeVarintCompliance(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Compliance) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
